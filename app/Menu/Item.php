...
class Item
{
    ...
    /**
     * items title in camelcase
     * @var string
     */
    public $nickname;

    /**
     * items separator of the rest of the items, if items has any
     * @var array
     */
